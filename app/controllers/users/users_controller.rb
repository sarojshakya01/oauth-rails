class Users::UsersController < ApplicationController
  def impersonate
    ...
    if @impersonate
      ...
      sign_in(:user, User.find(@impersonate.user_id))
      ...
      redirect_to Rails.application.config.ccan_app_url + '/404'
    end
  end
  ...
  def validate_impersonate_token token
    if token.length == 128
      ...
      return false if !User.where(id: @impersonate.user_id).exists?
